...
class Content(models.Model):
    ...
    cover       = models.ImageField(upload_to="cover/css/", default="default.png", blank=True)
    content     = models.TextField(blank=True)
    image       = models.ImageField(upload_to="image/css/", default="default.png", blank=True)
    ...
    image1      = models.ImageField(upload_to="image/css/", default="default.png", blank=True)
    ...
    image2      = models.ImageField(upload_to="image/css/", default="default.png", blank=True)
    ...
    image3      = models.ImageField(upload_to="image/css/", default="default.png", blank=True)

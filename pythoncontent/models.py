...
class Content(models.Model):
    ...
    cover       = models.ImageField(upload_to="cover/python/", default="default.png", blank=True)
    ...
    image1      = models.ImageField(upload_to="image/python/", default="default.png", blank=True)
    ...
    image2      = models.ImageField(upload_to="image/python/", default="default.png", blank=True)
    ...
    image3     = models.ImageField(upload_to="image/python/", default="default.png", blank=True)
    ...
    image4     = models.ImageField(upload_to="image/python/", default="default.png", blank=True)
